      ...
      <div className="w-full flex gap-12 gap-x-40 justify-center items-center flex-wrap px-[3vw] pt-20 ">
        <div className="h-[450px] max-xl:h-[650px] w-[850px] max-xl:order-2 ">
          <div className="mb-10 heading-area text-4xl max-xl:text-[7vw] tracking-tighter">
            Hey, I&apos;m <span className="text-cyan-400">Priyanshu</span> Kumar
            Sinha
          </div>
          <p className="tracking-tighter text-zinc-400 text-[16px] max-xl:text-[4vw] max-xl:leading-relaxed">
            I&apos;m a college student from Jamshedpur currently residing in
            Chennai, passionate about becoming a full stack web developer. With
            a focus on creating intuitive applications, I leverage technologies
            like React, Node.js, and MongoDB to build scalable solutions. My
            enthusiasm for problem-solving, especially in Data Structures and
            Algorithms (DSA), drives me to optimize solutions for efficiency and
            performance. Beyond coding, I actively pursue opportunities to
            expand my skills, ensuring a well-rounded approach to software
            development.
          </p>
          <div className="tracking-tighter xl:mt-20 mt-8 rounded-[20px]">
            <p className="px-4 bg-cyan-700 rounded-[20px] max-xl:text-[4vw] text-zinc-200 text-[17px] p-3">
              ...
              in full-stack development or discuss the new trending topic in 0-1
              world. ✨
            </p>
          </div>
        </div>
        <div className="h-[450px] max-xl:h-[500px] w-[300px] flex-col flex max-xl:order-1 ">
          <div className="relative group">
            ...
            <img
              className="h-[450px] flex items-center justify-center rounded-[30px] relative"
              src="/profile.jpg"
              alt=""
            />
          </div>
