  ...
  const PracticeProjectList = [
    {
      ...
      description: "Basically a Spotify clone but having extra features for free such as download option, skip, and fast-forward songs.",
      imgSrc: "/music.png"
    },
    {
      heading: "Note Me",
    ...
    },
    {
      ...
      description: "This was made by me while learning states and hooks in React. You can use this to generate a password of any length with the characters of your choice.",
      imgSrc: "/password.png"
    }
  ];
  ...
  return (
    <div className='w-full h-full relative'>
            ...
            <div className='w-[45vh] h-full rounded-3xl bg-zinc-800 flex justify-center hover:border hover:border-cyan-400'>
              <div className='w-[9vh] rounded-l-3xl mx-1 flex items-center justify-center'>
                <LazyLoad height={90} offset={100}>
                  <img className='w-[8vh] h-[8vh]' src={item.imgSrc} alt={item.heading} />
                </LazyLoad>
              </div>
      ...
      <div className='px-12 pt-5 max-xl:px-[6vw]'>
        ...
        <p className='tracking-tighter leading-tight text-base text-[18px] xl:w-3/4 text-zinc-400'>
          These are some of the practice projects I have completed while learning fundamental and essential concepts. Each of these projects is close to my heart as they represent significant steps in my learning journey.
        </p>
      </div>
      <div className='w-full max-xl:px-[6vw] py-12 px-12 flex max-xl:items-center max-xl:justify-center gap-12 flex-wrap'>
